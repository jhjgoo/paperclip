...
export function SidebarAccountMenu({
  ...
  const displayName = session?.user.name?.trim() || t("accountMenu.defaultName");
  const secondaryLabel =
    session?.user.email?.trim() || (deploymentMode === "authenticated" ? t("accountMenu.signedIn") : t("accountMenu.localWorkspace"));
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              <MenuAction
                label={t("accountMenu.viewProfile.label")}
              ...
              />
              <MenuAction
                label={t("accountMenu.editProfile.label")}
              ...
              />
              <MenuAction
                label={t("accountMenu.documentation.label")}
              ...
              />
              <MenuAction
                label={t("accountMenu.feedback.label")}
                description={t("accountMenu.feedback.description")}
                icon={Megaphone}
                href={FEEDBACK_URL}
                external
                onClick={() => setOpen(false)}
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-sm font-medium text-foreground">
                      {signOutMutation.isPending ? t("accountMenu.signOut.pending") : t("accountMenu.signOut.action")}
                    </span>

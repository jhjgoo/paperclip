      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem
            ...
            badgeLabel={t("navigation.unread")}
          ...
          {showDecisions ? (
            <SidebarNavItem
              ...
              badgeLabel={t("navigation.decisions")}
            />
          ) : null}
          {showStatusCards ? (
            <SidebarNavItem to="/status" label={t("navigation.status")} icon={LayoutGrid} textBadge={t("navigation.beta")} />
          ) : null}
        ...
        <SidebarSection label={t("navigation.work")} collapsible={{ open: workOpen, onOpenChange: setWorkOpen }}>
          ...
          {showCases ? (
            <SidebarNavItem to="/cases" label={t("navigation.cases")} icon={Layers} textBadge={t("navigation.beta")} />
          ) : null}
        ...
        <SidebarSection label={t("navigation.company")} collapsible={{ open: companyOpen, onOpenChange: setCompanyOpen }}>
          <SidebarNavItem to="/org" label={t("navigation.organization")} icon={Network} />

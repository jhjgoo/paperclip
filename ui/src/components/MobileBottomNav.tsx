...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("navigation.home"), icon: House },
      { type: "link", to: "/issues", label: t("navigation.tasks"), icon: CircleDot },
      { type: "action", label: t("navigation.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("navigation.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
